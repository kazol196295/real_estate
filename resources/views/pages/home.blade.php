                    ...
                    <div class="col-lg-12">
                        <div class="ltn__product-item ltn__product-item-4 text-center---">
                            <div class="product-img">
                                <a href="product-details.html"><img class="product-image"
                                        src="{{ asset('includes/products') . '/' . json_decode($item->image) }}"
                                        alt="#"></a>
                                <div class="product-badge">
                                    <ul>
                                        <li class="sale-badge bg-green">{{ $item->status }}</li>
                                    </ul>
                                </div>
                            ...
                            <div class="product-info">
                                ...
                                <ul class="ltn__list-item-2 ltn__list-item-2-before">
                                    <li><span>{{ $item->beds }} <i class="flaticon-bed"></i></span>
                                        Bedrooms
                                    </li>
                                    <li><span>{{ $item->baths }}<i class="flaticon-clean"></i></span>
                                        Bathrooms
                                    </li>
                                    <li><span>{{ $item->area }} <i
        ...
        <div class="container">
            ...
            <div class="row ltn__category-slider-active--- slick-arrow-1 justify-content-center">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="ltn__category-item ltn__category-item-5 text-center">
                        <a href="{{ route('shop') }}">
                            <span class="category-icon"><i class="fa-solid fa-person-swimming fa-beat"></i></span>
                            <span class="category-title">Swimming Pool</span>
                            <span class="category-btn"><i class="fa-solid fa-person-swimming"></i></span>
                        </a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="ltn__category-item ltn__category-item-5 text-center">
                        <a href="{{ route('shop') }}">
                            <span class="category-icon"><i class="fa-solid fa-bandage fa-beat"></i></span>
                            <span class="category-title">Medical center</span>
                            <span class="category-btn"><i class="fa-duotone fa-shield-halved"></i></span>
                        </a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="ltn__category-item ltn__category-item-5 text-center">
                        <a href="{{ route('shop') }}">
                            <span class="category-icon"><i class="fa-solid fa-fingerprint fa-beat"></i></span>
                            <span class="category-title">Security</span>
                            <span class="category-btn"><i class="fa-light fa-suitcase-medical"></i></span>
                        </a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="ltn__category-item ltn__category-item-5 text-center">
                        <a href="{{ route('shop') }}">
                            <span class="category-icon"><i class="fa-solid fa-book-open-reader"></i></span>
                            <span class="category-title">Library Area</span>
                            <span class="category-btn"><i class="fa-solid fa-book-open-reader"></i></span>
                        </a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="ltn__category-item ltn__category-item-5 text-center">
                        <a href="{{ route('shop') }}">
                            ...
                            <span class="category-btn"><i class="fa-solid fa-bed"></i></span>
                        </a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="ltn__category-item ltn__category-item-5 text-center">
                        <a href="{{ route('shop') }}">
                            <span class="category-icon"><i class="fa-solid fa-house-signal"></i></span>
                            <span class="category-title">Smart Homes</span>
                            <span class="category-btn"><i class="fa-solid fa-house-signal"></i></span>
                        </a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="ltn__category-item ltn__category-item-5 text-center">
                        <a href="{{ route('shop') }}">
                            <span class="category-icon"><i class="fa-solid fa-baseball-bat-ball fa-beat"></i></span>
                            <span class="category-title">Kid’s Playland</span>
                            <span class="category-btn"><i class="fa-duotone fa-cricket-bat-ball"></i></span>
                        </a>
                    </div>
                </div>
            </div>
