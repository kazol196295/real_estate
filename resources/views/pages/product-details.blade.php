            ...
            <div class="row">
                <div class="col-lg-8 col-md-12">
                    <div class="ltn__shop-details-inner ltn__page-details-inner mb-60">
                        ...
                        <h1>{{$product->name}}</h1>
                        <label><span class="ltn__secondary-color"><i class="flaticon-pin"></i></span> {{$product->location}}</label>
                        ...
                        <div class="property-detail-info-list section-bg-1 clearfix mb-60">
                            <ul>
                                <li><label>Property ID:</label> <span>{{$product->id}}</span></li>
                                <li><label>Home Area: </label> <span>{{$product->area}} sqft</span></li>
                                <li><label>Rooms:</label> <span>{{$product->rooms}}</span></li>
                                <li><label>Baths:</label> <span>{{$product->baths}}</span></li>

                            </ul>
                            <ul>
                                <li><label>Lot Area:</label> <span>HZ29 </span></li>
                                <li><label>Lot dimensions:</label> <span>120 sqft</span></li>
                                <li><label>Beds:</label> <span>{{$product->beds}}</span></li>
                                <li><label>Price:</label> <span>{{$product->price}}</span></li>
                                <li><label>Property Status:</label> <span>{{$product->status}}</span></li>
                            </ul>
                        </div>
