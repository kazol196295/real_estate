                                            ...
                                            <div
                                                ...
                                                <div class="product-info">
                                                    <div class="product-badge">
                                                        <ul>
                                                            <li class="sale-badg"><span>{{ $product->status }}</span></li>
                                                        </ul>
                                                    </div>
                                                    ...
                                                    <ul
                                                        ...
                                                        <li><span> {{ $product->beds }} </span>
                                                            Bed
                                                        </li>
                                                        <li><span> {{ $product->bath }} </span>
                                                            Bath
                                                        </li>
                                                        <li><span> {{ $product->rooms }} </span>
                                                            Bath
                                                        </li>



                                                        <li><span>{{ $product->area }} </span>
                                                            Square Ft
                                                        </li>
                                                    </ul>
